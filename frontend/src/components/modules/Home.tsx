          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Choose from Random Forest and XGBoost algorithms for best
                predictions.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">
                Instant Crop Analysis - Predictions
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Get instant predictions based on your input data for quick decision making.
              </p>
            </motion.div>
